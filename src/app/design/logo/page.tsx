        ...
        <div className="mx-auto max-w-7xl px-4 py-10">
          ...
          <nav aria-label="breadcrumb" className="mb-4 text-sm text-slate-600">
            <ol className="flex items-center gap-2">
              ...
              <li className="opacity-60">/</li>
              <li className="font-semibold text-slate-700">تصميم وتطوير الشعارات</li>
              <li className="opacity-60">/</li>
              <li className="font-bold text-slate-900">تصميم شعار</li>
            </ol>
          </nav>

          <div className="flex flex-col items-center text-center">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900">تصميم شعار</h1>
            ...
            <div className="mt-6 flex w-full max-w-xl items-center gap-2">
              <div className="relative w-full">
                ...
                <input
                  ...
                  placeholder="ابحث عن خدمة تصميم شعار…"
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-9">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-bold text-slate-900">{filtered.length} خدمة — تصميم شعار</h2>
